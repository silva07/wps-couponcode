...
* Create additional buttons with discounts assigned through the HTML Variables available at www.paypal.com.  See our screencast on how to apply discounts to buy now button.
* Add the hostedButtonIds for the discounts below to the array. Also, add the discount amount.  
* Note, this example is using a fixed discount amount.
* If you want to use a percentage discount, update this code $amount = ($amount - $discount);
